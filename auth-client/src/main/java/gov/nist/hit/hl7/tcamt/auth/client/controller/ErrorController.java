package gov.nist.hit.hl7.tcamt.auth.client.controller;
...
import gov.nist.hit.hl7.tcamt.auth.client.util.ErrorReport;
import gov.nist.hit.hl7.tcamt.auth.client.emails.service.ErrorEmailService;
@RestController
