 ...
 */
package gov.nist.hit.hl7.tcamt.auth.client.emails.service.impl;
...
import gov.nist.hit.hl7.tcamt.auth.client.emails.service.AccountManagmenEmailService;
...
public class AccountManagmenEmailServiceImpl implements AccountManagmenEmailService {
   ...
   * 
   * @see
   * gov.nist.hit.hl7.tcamt.auth.client.emails.service.AccountManagmenEmailService#sendResgistrationEmail(
   ...
   * 
   * @see
   * gov.nist.hit.hl7.tcamt.auth.client.emails.service.AccountManagmenEmailService#sendRestPasswordSuccess(
   * java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
   ...
   * 
   * @see
   * gov.nist.hit.hl7.tcamt.auth.client.emails.service.AccountManagmenEmailService#sendResetTokenUrl(java.
